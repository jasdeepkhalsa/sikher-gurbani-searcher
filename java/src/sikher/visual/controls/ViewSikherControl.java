 ...
 * Date: 25.01.2006
 * Time: 13:26:11
 * $Header: /cvsroot/sikher/sikher_java/src/sikher/visual/controls/ViewSikherControl.java,v 1.1 2006/04/21 13:04:12 mamonts Exp $
 * $Log: ViewSikherControl.java,v $
 * Revision 1.1  2006/04/21 13:04:12  mamonts
 * First commtin
 *
 * Description:
 */
public class ViewSikherControl extends SikherComponent {

    public ViewSikherControl( XPathSearcher searcher, SikherIni ini, StatusBar statusBar ) {
        super(searcher, ini, statusBar, new BorderLayout());
        _FinitComponents();
    }

    public String getControlName() {
        return SikherProperties.getString("control.view.name");
    }
