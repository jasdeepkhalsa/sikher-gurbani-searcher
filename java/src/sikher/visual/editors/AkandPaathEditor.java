 ...
 * Date: 05.02.2006
 * Time: 11:03:55
 * $Header: /cvsroot/sikher/sikher_java/src/sikher/visual/editors/AkandPaathEditor.java,v 1.1 2006/04/21 13:05:40 mamonts Exp $
 * $Log: AkandPaathEditor.java,v $
...
public class AkandPaathEditor extends AbstractSikherEditor{
    public static final String EDITOR_NAME = "akand-paath";

    public AkandPaathEditor( XPathSearcher searcher, SikherIni ini, StatusBar statusBar ) {
    ...
    public String getControlName() {
        return SikherProperties.getString("editor.akand.name");
    }
